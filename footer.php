                    ...
                    <div class="footer-items contact ">
                        ...
                        <div class="email mb-30">
                            ...
                            <div class="email-info">
                                <h6 class="mb-10"><a href="mailto:info@example.com">info@capymarket.com</a></h6>
                ...
                <div class="col-lg-6 d-flex align-items-center order-lg-2 order-1 justify-content-sm-center justify-content-start">
                    <div class="footer-items">
                        <h2>want <span>to keep</span><br>
                            Updated, <span>About Them</span>?</h2> 
                        <div class="book-btn">
                        
                        <?php mc4wp_custom_shortcode(90) ?>
            ...
            <div class="row border-top">
                <div class="col-lg-6">
                    <div class="copyright-area">
                        <p>© 2023 Rafael Agar <a href="https://www.rafaelagar.com/"> </a></p>
                    </div>
                </div>
